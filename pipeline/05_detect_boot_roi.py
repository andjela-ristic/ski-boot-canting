...
STEP_05_CONFIG = CONFIG["step_05_detect_boot_roi"]

PROCESSED_DIR = PROJECT_ROOT / PATHS_CONFIG["processed_dir"]
METADATA_DIR = PROJECT_ROOT / PATHS_CONFIG["metadata_dir"]

EDGES_INPUT_DIR = PROCESSED_DIR / STEP_05_CONFIG["input_edges_subdir"]
VISUAL_INPUT_DIR = PROCESSED_DIR / STEP_05_CONFIG["input_visual_subdir"]

OUTPUT_DIR = PROCESSED_DIR / STEP_05_CONFIG["output_subdir"]
...
CSV_PATH = METADATA_DIR / "processing_05_detect_boot_roi.csv"
...
def create_roi_mask(
    ...
    padding_config = STEP_05_CONFIG["roi_padding"]
    ...
    for index, edge_path in enumerate(image_paths, start=1):
        ...
        if selected_component is None:
            row = {
                ...
                "width": width,
                "height": height,
                "processing_step": "05_detect_boot_roi",
