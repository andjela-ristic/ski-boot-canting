...
from lib import step_06_search_central_ruler_lib as step06_lib
...
def main() -> None:
    ...
    step06_lib.context.STEP_CONFIG = step06_lib.apply_preset(step06_lib.context.STEP_CONFIG, args.preset)
    if args.output_subdir:
        step06_lib.context.STEP_CONFIG["output_subdir"] = args.output_subdir
    if args.save_all_candidates:
        step06_lib.context.STEP_CONFIG["save_all_final_candidates"] = True
    if args.max_saved_candidates is not None:
        step06_lib.context.STEP_CONFIG.setdefault("candidate_deduplication", {})
        step06_lib.context.STEP_CONFIG["candidate_deduplication"]["max_saved_candidates"] = int(args.max_saved_candidates)
